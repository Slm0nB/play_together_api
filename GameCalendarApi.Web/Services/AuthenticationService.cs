...
namespace GameCalendarApi.Services
{
    public class AuthenticationService
    {
        readonly IConfiguration _config;
        readonly Domain.GameCalendarDbContext _dbContext;

        public AuthenticationService(IConfiguration config, GameCalendarDbContext dbContext)
        {
            _config = config;
